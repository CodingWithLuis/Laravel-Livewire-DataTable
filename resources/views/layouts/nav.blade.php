            ...
            <ul class="navbar-nav ms-auto">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li>
                            <button type="button" class="dropdown-item" wire:click="$emit('showModal', 'auth.profile-update')">
                                {{ __('Update Profile') }}
                            </button>
                        </li>
                        <li>
                            <button type="button" class="dropdown-item" wire:click="$emit('showModal', 'auth.password-change')">
                                {{ __('Change Password') }}
                            </button>
                        </li>
                        <li>
